    ...
    def setBoundaries(self):
        ...
        for i in range(n - 1): 
            def recursionlambdaMin(lambda_min_1, lambda_min_2):                  # Rekursiv holatda lambda_min ni topish. Farqi 0.001 bo'lguncha izla             
                ...
                if round(lambda_min_1, f) == round(lambda_min_2, f) and (np.sum(objL1C[:,i] == 3)):             # lambda_min_1 va lambda_min_2 verguldan keyingi f ta raqami bir xil bo'lguncha davom et
                ...
                count_anomolouses = np.sum(obj_status[:,i] == 3)
            ...
            def recursionlambdaMax(lambda_max_1, lambda_max_2):                  # Rekursiv holatda lambda_max ni topish. Farqi 0.001 bo'lguncha izla
                ...
                elif np.sum(obj_status_2[:,i] == 3) == 0:
